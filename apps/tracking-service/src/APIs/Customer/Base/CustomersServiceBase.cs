...
using TrackingService.APIs.Dtos;
using TrackingService.APIs.Errors;
using TrackingService.APIs.Extensions;
...
{
    protected readonly TrackingServiceDbContext _context;

    public CustomersServiceBase(TrackingServiceDbContext context)
    {
        _context = context;
    }
